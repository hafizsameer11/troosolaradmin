                  ...
                  <div className="space-y-4">
                    ...
                    <div className="border rounded-lg p-4 space-y-3 bg-gray-50">
                      ...
                      <div className="pt-3 border-t border-gray-200 space-y-2">
                        ...
                        <input type="text" className="w-full border border-gray-300 rounded-lg px-3 py-2" placeholder="Business Bank Account Statement (Last 6 Months)" value={loanSettingsForm.credit_check_sme_manual_bank_label} onChange={(e) => setLoanSettingsForm((f) => ({ ...f, credit_check_sme_manual_bank_label: e.target.value }))} />
