...
export const updateBNPLSettings = async (
  payload: {
    ...
    financing_path_intro?: string;
    financing_path_troosolar_title?: string;
    ...
    credit_check_residential_manual_upload_intro?: string;
    ...
    credit_check_sme_manual_upload_intro?: string;
